...
function fetchSpec(specUrl) {
  ...
  // git archive --remote=git@gitlab.disney.com:softwareartisan/poc/openapi-redoc.git HEAD public/oa-specs/meta-manager.yml --output=test.md
  // git archive --remote=git@gitlab.disney.com:softwareartisan/poc/openapi-redoc.git HEAD public/oa-specs/meta-manager.yml | tar -xO 
